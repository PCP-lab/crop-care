...
abstract class AppLocalizations {
  ...
  /// No description provided for @homeInstruction.
  ///
  /// In en, this message translates to:
  /// **'Tap on the card to start'**
  ...
  /// No description provided for @plantFactMoisture.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @dateNoticed.
  ///
  /// In en, this message translates to:
  /// **'Date noticed'**
  String get dateNoticed;
  ...
  ///
  /// In en, this message translates to:
  /// **'Describe what you see(spots,discoloration,pests,wilting, ec.)'**
